...
def dashboard():
    ...
    def main():
        ...
        def add_items():
            ...
            Button(add_f, image=add_save, bg="#565050", bd=0, activebackground="#565050", command=database_storing
                   ).place(x=1157, y=47)
            ...
            def A_login_frame():
                ...
                return [Web_name.get(), add_email_u.get(), add_password.get()]
            ...
            def A_card_frame():
                ...
                return [c_name.get(), vf.get(), vt.get(), c_name.get(), cvv.get()]
        ...
        Button(
            main_f, image=emails_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=281, y=360)

        social_b = PhotoImage(file="Images/Socials Folder.png")
        Button(
            main_f, image=social_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=281, y=408)

        finances_b = PhotoImage(file="Images/Finance Folder.png")
        Button(
            main_f, image=finances_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=281, y=456)

        games_b = PhotoImage(file="Images/Game Folder.png")
        Button(
            main_f, image=games_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=281, y=504)

        shopping_b = PhotoImage(file="Images/Shopping Folder.png")
        Button(
            main_f, image=shopping_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=281, y=552)
        ...
        Button(
            main_f, image=work_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=753, y=360)

        academics_b = PhotoImage(file="Images/Academics Folder.png")
        Button(
            main_f, image=academics_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=753, y=408)

        misc_b = PhotoImage(file="Images/Miscellaneous Folder.png")
        Button(
            main_f, image=misc_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=753, y=456)

        unassigned_b = PhotoImage(file="Images/Unassigned Folder.png")
        Button(
            main_f, image=unassigned_b, bg="#838080", bd=0, activebackground="#838080"
        ).place(x=753, y=504)
