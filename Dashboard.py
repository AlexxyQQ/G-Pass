            ...
            def database_storing():
                ...
                if clicked.get() == 'Login':
                    ...
                    try:
                        ...
                        d.execute('INSERT INTO AddedLogins VALUES (:w_name,:email_u,:password,:folder)'
                                  , {
                ...
                if clicked.get() == 'Card':
                    ...
                    try:
                        ...
                        d.execute('INSERT INTO AddedCards VALUES (:cn,:vf,:vt,:cna,:cv)'
                                  , {
                ...
                if clicked.get() == 'Note':
                    ...
                    try:
                        ...
                        d.execute(' CREATE TABLE AddedNotes(Note_name text,folder text,notes text) '
                                  )
                        db.commit()

                        # writing in table if it doesn't already exist

                        d.execute('INSERT INTO AddedNotes VALUES (:n_name,:folder,:note)'
