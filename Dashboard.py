...
def dashboard():
    ...
    def main():
        global bg_image, image_bg, folder_frame, user_image, topcard, addbutton, vault, generate, settings, trash, edit_user
        ...
        def add_items():
            ...
            def A_login_frame():
                ...
                Label(add_login, image=Add_login_entries, bg="#C4C4C4").place(
                    x=20, y=59
                )

                Label(
                    add_login, text="Website Name", font=("Arial", 15), bg="#C4C4C4"
                ).place(x=49, y=29)

                Label(
                    add_login, text="Username/Email", font=("Arial", 15), bg="#C4C4C4"
                ).place(x=49, y=143)

                Label(
                    add_login, text="Password", font=("Arial", 15), bg="#C4C4C4"
                ).place(x=49, y=262)
            ...
            def A_note_frame():
                ...
                Label(add_note, image=back_note, bg="#565050").place(x=0, y=0)
            ...
            drop["menu"].configure(
                font=("Arial", 20), bg="#C4C4C4", bd=0, activebackground="#C4C4C4"
            )
        ...
        Button(
            main_f, image=vault, bg="#C4C4C4", bd=0, activebackground="#C4C4C4"
        ).place(x=62, y=86)
        ...
        Button(
            main_f, image=trash, bg="#C4C4C4", bd=0, activebackground="#C4C4C4"
        ).place(x=161, y=636)

        edit_user = PhotoImage(file="Images/Edit Image and Profile.png")
        Button(
            main_f, image=edit_user, bg="#565050", bd=0, activebackground="#565050"
        ).place(x=1186, y=207)
        ...
        def folder_display():
            ...
            global emails_b, social_b, finances_b, games_b, shopping_b, entertainment_b, work_b, academics_b, misc_b, \
                unassigned_b, login_B, card_B, securenotes_B

            s_c = LabelFrame(main_f, width=922, height=294, bd=0, bg="#838080")
            s_c.place(x=274, y=350)

            f_d = LabelFrame(main_f, width=922, height=294, bd=0, bg="#838080")
            ...
            def social_folder():
                ...
                Label(s_c, image=social_b, bg="#838080").place(x=801, y=6)
            ...
            def finacne_folder():
                ...
                Label(s_c, image=finances_b, bg="#838080").place(x=775, y=6)
            ...
            def game_folder():
                ...
                Label(s_c, image=games_b, bg="#838080").place(x=801, y=6)
            ...
            def shopping_folder():
                ...
                Label(s_c, image=shopping_b, bg="#838080").place(x=769, y=6)
            ...
            def academic_folder():
                ...
                Label(s_c, image=academics_b, bg="#838080").place(x=750, y=6)
            ...
            def unassign_folder():
                ...
                Label(s_c, image=unassigned_b, bg="#838080").place(x=740, y=6)
            ...
            def card_all():
                ...
                d.execute("SELECT *, oid FROM AddedCards")
                all = d.fetchall()
                l = Listbox(
                    s_c,
                    width=77,
            ...
            def notes_all():
                ...
                d.execute("SELECT *, oid FROM AddedNotes")
                all = d.fetchall()
                l = Listbox(
                    s_c,
                    width=77,
            ...
            Button(
                main_f, image=login_B, bg="#838080", bd=0, activebackground="#838080", command=login_all
            ).place(x=307, y=71)

            card_B = PhotoImage(file="Images/Card.png")
            Button(
                main_f, image=card_B, bg="#838080", bd=0, activebackground="#838080", command=card_all
            ).place(x=307, y=122)

            securenotes_B = PhotoImage(file="Images/Secure Notes.png")
            Button(
                main_f, image=securenotes_B, bg="#838080", bd=0, activebackground="#838080", command=notes_all
            ).place(x=307, y=172)
