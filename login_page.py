...
def signup_page():
    ...
    def sign_click():
        if len(s_password.get()) > 14:
            too_long = Label(
                signup_frame,
                text="Bruh can you even remember this? Type something short. ",
                font=("Arial", 15),
                bg="#2FB2AB",
            )
            too_long.pack()
            ...
            try:
                ...
                if status == "valid":
                    ...
                    check_email = Label(
                        signup_frame,
                        text="Wrong email, Please check your email address",
                    ).pack()
                else:
                    s.quit()
                ...
                s.quit()
                check_email = Label(
                    signup_frame, text="Wrong email, Please check your email address"
                ).pack()
